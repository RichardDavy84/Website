---
title: KrigR Workshop - Introduction to the R Package
author: Erik Kusch
date: '2021-01-28'
slug: krigrworkshop
categories:
...
tags:
 ...
 - KrigR
subtitle: 'Climate Data for your Study Needs'
summary: 'A short introduction to the KrigR R Package designed to download, aggregate, and statistically downscale state-of-the-art climate data.'
authors: []
lastmod: '2021-05-05T10:00:00+01:00'
featured: no
image:
 caption: ''
 focal_point: ''
...
A recording of me presenting much of the contents herein can be found on [YouTube](https://www.youtube.com/watch?v=wwb107L4wVw&ab_channel=ErikKusch).
...
```{r ClimExt, fig.keep = 'all', fig.height = 4}
...
```{r StateShape, tidy = FALSE, warning = FALSE, message = FALSE}
...
```{r PointsMap1, tidy = FALSE, warning = FALSE, message = FALSE}
...
```{r echo = FALSE}
unlink(file.path(Dir.NDVI, "2m_temperature_2000-01-01_2000-12-31_year.nc"), recursive = TRUE) # remove NDVI file for potential reruns
```
