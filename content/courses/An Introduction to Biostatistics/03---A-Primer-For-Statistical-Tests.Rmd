...
I have prepared some [Lecture Slides](/courses/An Introduction to Biostatistics/03---A-Primer-For-Statistical-Tests_Handout.pdf) for this session. Unfortunately, they are in pdf format, so you will have to download them straight to your PC.

# Data
Find the data for this exercise [here](/courses/An Introduction to Biostatistics/Data/Primer.RData).
